        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute top-12 left-0 w-full h-px">
             <svg width="100%" height="1" className="overflow-visible">
                ...
                <line x1="0" y1="0" x2="100%" y2="0" strokeWidth="2" stroke="hsl(var(--accent))" strokeDasharray="5, 10" strokeLinecap="round" markerEnd="url(#arrowhead)" markerStart="url(#arrowhead)"/>
            </svg>
          </div>
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative flex items-start w-full md:flex-col md:w-auto px-4 mb-12 md:mb-0">
                ...
                {index < steps.length - 1 && (
                  <div className="md:hidden absolute top-12 left-12 w-px h-full -translate-x-1/2">
                    <svg width="1" height="100%" className="overflow-visible">
                      ...
                      <line x1="0" y1="0" x2="0" y2="100%" strokeWidth="2" stroke="hsl(var(--accent))" strokeDasharray="5, 10" strokeLinecap="round"  markerEnd="url(#arrowhead-mobile)" />
                    </svg>
                  </div>
                )}
                
                <div className="flex-shrink-0 flex flex-col items-center text-center mr-6 md:mr-0 md:mb-4 z-10">
                ...
                <div className="flex-grow text-left md:text-center pt-2 md:pt-0">
                 ...
                 {index < steps.length -1 && (
                    <div className="hidden md:flex flex-grow items-center justify-center min-w-[50px] lg:min-w-[100px] z-10">
